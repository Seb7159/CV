...
\item Developed and maintained the company\textsc{\char13}s main software product in a fast-paced environment by writing code in the CakePHP web framework using the MVC pattern, while practicing Agile.
\end{rSubsection}
...
\item Volunteered on JPMorgan\textsc{\char13}s Corporate Responsability Day to preserve the nature around Dorset.
